...
| `docs/architecture/system-overview.md` | `docs/backend/*`, `docs/frontend/*`, `docs/architecture/data-model.md`, `docs/architecture/integrations.md`, `docs/architecture/stack.md`, `docs/operations/*` | Не изменились ли модули, границы системы, связи, внешние сервисы, эксплуатационные последствия |
| `docs/architecture/stack.md` | `system-overview.md`, `architecture-decisions/ADR-0001-*`, `backend-docs.md`, `frontend-docs.md`, `environments.md` | Не изменился ли подтверждённый стек или monorepo layout |
| `docs/architecture/architecture-decisions/*` | `system-overview.md`, `stack.md`, затронутые domain docs | ADR отражает актуальное решение и consequences |
| `docs/operations/environments.md` | `docker-compose.yml`, `.env.example`, `backend-docs.md`, `frontend-docs.md`, `secrets-management.md` | Env vars, порты, сервисы Docker совпадают с репозиторием |
