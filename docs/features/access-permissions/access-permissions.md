...
Related API: API-AUTH-001 … API-AUTH-004, API-SCOPE-001 … API-SCOPE-002, API-PERM-001 … API-PERM-004, API-AUDIT-001 — `docs/architecture/api-contracts.md`
Related data model: Tenant, Workspace, User, ModulePermission, ManagerScope, AuditLog — `docs/architecture/data-model.md`
...
- Roadmap: STAGE-001 (done) — [roadmap-access-permissions.md](../../project/roadmap-access-permissions.md)
- Code: `apps/api/accounts/` (cookie auth, blacklist logout), `apps/web/src/lib/api.ts`, `apps/web/src/app/login/`, `apps/web/src/components/ProtectedShell.tsx`
- Pages: PAGE-001 (login), PAGE-006 Access tab (permissions, audit log, knowledge grants)
