...
Единый словарь терминов. При добавлении новых сущностей — дополнять соответствующий файл.

---

## Быстрый поиск по категориям

| Категория | Термины | Файл |
|-----------|---------|------|
| Организация | Workspace, Admin, Manager, Employee | [docs/glossary/org-and-access.md](./docs/glossary/org-and-access.md) |
...
| **Pipeline** | Настраиваемые этапы продаж |
| **Stage** | Конкретный этап pipeline |
| **Touchpoint** | Звонок, встреча, переписка |
| **Quality Criterion** | Правило оценки коммуникации |
| **Evaluation** | Результат AI-анализа touchpoint |
